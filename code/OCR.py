...
def convert_pdf_to_image(pdf_path):
    ...
    return pdf2image.convert_from_path(pdf_path, first_page=0, last_page=1)
...
print(extracted_texts[0][:1000])  # Print only the first 1000 characters to avoid too long output
